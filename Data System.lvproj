...
<Project Type="Project" LVVersion="20008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Controls" Type="Folder">
			<Item Name="Comm Data.ctl" Type="VI" URL="../Controls/Comm Data.ctl"/>
			<Item Name="Data Process Data.ctl" Type="VI" URL="../Controls/Data Process Data.ctl"/>
			<Item Name="File Handling Data.ctl" Type="VI" URL="../Controls/File Handling Data.ctl"/>
			<Item Name="UI Data.ctl" Type="VI" URL="../Controls/UI Data.ctl"/>
		</Item>
		<Item Name="Docs" Type="Folder">
			<Item Name="NI排隊消息處理程序架構說明(google翻譯).pdf" Type="Document" URL="../Docs/NI排隊消息處理程序架構說明(google翻譯).pdf"/>
			<Item Name="README.md" Type="Document" URL="../Docs/README.md"/>
			<Item Name="需求架構描述.jpg" Type="Document" URL="../Docs/需求架構描述.jpg"/>
			<Item Name="模組功能說明.md" Type="Document" URL="../Docs/模組功能說明.md"/>
		</Item>
		<Item Name="Libraries" Type="Folder">
			<Property Name="NI.SortType" Type="Int">3</Property>
			<Item Name="Message Queue.lvlib" Type="Library" URL="../Libraries/Message Queue/Message Queue.lvlib"/>
			<Item Name="User Event - Stop.lvlib" Type="Library" URL="../Libraries/User Event - Stop/User Event - Stop.lvlib"/>
			<Item Name="Check Loop Error.vi" Type="VI" URL="../Libraries/Check Loop Error.vi"/>
			<Item Name="Error Handler - Event Handling Loop.vi" Type="VI" URL="../Libraries/Error Handler - Event Handling Loop.vi"/>
			<Item Name="Error Handler - Message Handling Loop.vi" Type="VI" URL="../Libraries/Error Handler - Message Handling Loop.vi"/>
		</Item>
		<Item Name="Modules" Type="Folder">
			<Item Name="Communication Module.vi" Type="VI" URL="../Modules/Communication Module.vi"/>
			<Item Name="Data Processing Module.vi" Type="VI" URL="../Modules/Data Processing Module.vi"/>
			<Item Name="File Handling Module.vi" Type="VI" URL="../Modules/File Handling Module.vi"/>
		</Item>
		<Item Name="Tests" Type="Folder"/>
		<Item Name="Main.vi" Type="VI" URL="../Main.vi"/>
		<Item Name="檔案架構.md" Type="Document" URL="../檔案架構.md"/>
